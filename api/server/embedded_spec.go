...
func init() {
  ...
  "paths": {
    ...
    "/authorize": {
      "get": {
        "description": "Gererates an oauth authorization request for login and redirects the browser to the login form.\n\nThis method will redirect the browser to ` + "`" + `login_uri` + "`" + ` with an encoded ` + "`" + `request_token` + "`" + ` parameter, which will present the user with a login form.\n\n  ` + "`" + `login_uri` + "`" + ` and ` + "`" + `redirect_uri` + "`" + ` must be registered with the api client.\n\nThe form should post back to ` + "`" + `/login` + "`" + ` which will perform the final redirect to ` + "`" + `redirect_api` + "`" + ` with the authorization code.\n\nErrors will be delivered to ` + "`" + `redirect_uri` + "`" + ` with two query parameters:\n\n\n  - ` + "`" + `error=\u003cerror name\u003e` + "`" + ` (i.e. ` + "`" + `bad_request` + "`" + `, etc) \n  - ` + "`" + `error_description=\u003cerror detail\u003e` + "`" + `\n",
        "tags": [
          "Auth"
        ],
        ...
        "parameters": [
          ...
          {
            "type": "string",
            "description": "The URL to which the authentication server redirects the browser for login",
            "name": "login_uri",
            "in": "query"
          },
          {
  ...
  "tags": [
    ...
    {
      "description": "User methods provide access to user and session information\n",
      "name": "User"
    }
  ]
}`))
